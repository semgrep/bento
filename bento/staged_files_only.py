...
import bento.git_util
from bento.util import CalledProcessError, cmd_output, mkdirp
from bento.xargs import xargs
...
def _intent_to_add_cleared():
    intent_to_add = bento.git_util.intent_to_add_files()
    if intent_to_add:
