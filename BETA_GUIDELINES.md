...
Once you run ```bento check```, feel free to fix issues, ignore warnings, or disable specific checks (e.g., ```bash bento disable r2c.eslint arrow-parens```). Just use Bento as many times as you'd like to use. 🤞
